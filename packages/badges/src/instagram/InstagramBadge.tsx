...
export interface InstagramBadgeProps extends Omit<SocialBadgeProps, 'platformName' | 'colors' | 'logoComponent'> {
...
export const InstagramBadge: React.FC<InstagramBadgeProps> = ({
  ...
  // Instagram gradient colors for light and dark themes
  const igColors = {
    light: {
      border: '#E1306C20',
      text: '#E1306C',
  ...
  const colors = theme === 'dark' ? igColors.dark : igColors.light;

  // Instagram logo with updated SVG
  const igLogo = (
    <svg width="29" height="29" viewBox="0 0 3364.7 3364.7" xmlns="http://www.w3.org/2000/svg">
      <defs>
